...
.mobile-panel{position:absolute;left:14px;right:14px;top:60px;background:#111118;border:1px solid var(--border);border-radius:10px;padding:10px;box-shadow:0 18px 50px rgba(0,0,0,.42);z-index:120}
.mobile-panel a{display:block;color:var(--text);text-decoration:none;font-size:14px;font-weight:750;padding:10px;border-radius:7px}
...
@media(max-width:720px){h1{font-size:34px}.grid,.links{grid-template-columns:1fr}header{padding:12px 16px}.main-nav,.header-right{display:none}.mobile-menu{display:block}.footer-inner{grid-template-columns:1fr;text-align:center}.footer-center,.footer-credit{grid-column:1;justify-self:center;text-align:center}}
</style>
</head>
<body>
<header>
